...
<body class="fill-height bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav ml-auto">
                ...
                if (isset($_SESSION["user"])) {
                    ...
                    echo ('<a class="dropdown-item active" href="adminStats.php">Statystyki pytań</a>');
    ...
    <div class="container-fluid text-center text-light pt-3 pb-3">
        <h2 class="m-3">10 najtrudniejszych pytań</h2>
        <?php
        include("../scripts/generate_hardest_table.php");
        ?>
        <h2 class="m-3">Wszystkie pytania</h2>
        <?php
        include("../scripts/generate_stats_table.php");
        ?>
    </div>
