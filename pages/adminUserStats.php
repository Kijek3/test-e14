...
<head>
    ...
    <title>Statystyki użytkowników</title>
...
<body class="fill-height bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav ml-auto">
                ...
                if (isset($_SESSION["user"])) {
                    ...
                    echo ('<a class="dropdown-item active" href="adminUserStats.php">Statystyki użytkowników</a>');
    ...
    <div class="container-fluid text-center text-light pt-3 pb-3">
        <h2 class="m-3">10 najlepszych użytkowników</h2>
        <?php
        include("../scripts/generate_users_best_table.php");
        ?>
        <h2 class="m-3">Wszyscy użytkownicy</h2>
        <?php
        include("../scripts/generate_users_stats_table.php");
        ?>
    </div>
