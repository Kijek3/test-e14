...
<head>
    ...
    <title>Zarządzanie pytaniami</title>
...
<body class="fill-height bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav ml-auto">
                ...
                if (isset($_SESSION["user"])) {
                    ...
                    echo ('<a class="dropdown-item active" href="questionPanel.php">Zarządzaj pytaniami</a>');
    ...
    <div class="container-fluid text-center text-light pt-3 pb-3">
        <div class="container-fluid p-0 mt-3 mb-3">
            <a href="addQuestion.php"><button type="submit" class="btn btn-success btn-block">Dodaj pytanie</button></a>
        </div>
        <?php
        include("../scripts/generate_questions_table.php");
        ?>
    </div>
